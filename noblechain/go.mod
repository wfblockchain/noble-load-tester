...
replace (
	...
	github.com/wfblockchain/noble-cctp => ./noble-cctp
	github.com/wfblockchain/noble-fiattokenfactory => ./noble-fiattokenfactory
	github.com/wfblockchain/noble-paramauthority => ./noble-paramauthority
